...
<SCRIPT language="javascript">
 ...
 function validateNamingStandard(){
	 
	 var div = document.getElementById('validateStandardTable');
 ...
 var selectedObjects = "";
	...
	var max = checkbox.length;
	  ...
	  var xmlHttpReq = false;
		...
		var url = "validateNamingStandard.do?";
		var parameters="slctdDbObj=" + selectedObjects+"&dbName="+dbName;
		...
		self.xmlHttpReq.onreadystatechange = function() {
			if (self.xmlHttpReq.readyState == 4) {
				...
				var div1 = document.getElementById('validateStandardTable');
...
<td>
	...
	<tr><td width="20px"></td>
   <td><html:button property="save" onclick="validateNamingStandard()"  styleClass="button">Naming Standard Violations</html:button></td></tr>
 <tr><td width="20px"></td>
   <td>

	<div style="height:400px; overflow:auto;" style="display: none;" id="validateStandardTable">
